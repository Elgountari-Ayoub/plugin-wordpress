...
Description: Add feedback functionality to pages and posts ayoub
Version: 1.0
Author: Ayoub
Author URL:
*/
...
function feedback_plugin_options_page()
{
    ...
    <div class="feedback-form">
      <form method="post">
        <label for="feedback_note">Number (0-10): *</label>
        <input type="number" name="feedback_note" id="feedback_note" min="0" max="10" required>
